...
public class Dead : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (Vector2.Distance(transform.position, toMove) < 8f && (((gv.team1 != 2 && gv.team1 != 1 && target == "Team2") || (gv.team2 != 2 && gv.team2 != 1 && target == "Team1"))))
        {
        ...
        if (!isReloading) anim.Play("DeadWalk");
    ...
    IEnumerator AttackAnimation()
    {
        ...
        b.GetComponent<DeadProjectile>().Etag = Etag;
        b.GetComponent<DeadProjectile>().moveTo = toMove;
