...
public class Marrowkai : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        anim.Play("MarrowkaiWalk");
        if (Vector2.Distance(transform.position, toMove) < 8f && (((gv.team1 != 2 && gv.team1 != 1 && gv.team1 != 4 && target == "Team2") || (gv.team2 != 2 && gv.team2 != 1 && gv.team2 != 4 && target == "Team1"))) && ((isReloading) || isAttackingReaper))
        {
            return;
        }
