...
if(__name__ == "__main__"):
    ...
    agent1 = Agent(gamma=0.99,epsilon=.5,lr=4e-4, input_dims=[512],n_actions=12, mem_size=1_000_000, eps_min=0.01, batch_size=64, checkpoint_name="team1",eps_dec=2e-5,replace=100)
    agent2 = Agent(gamma=0.99,epsilon=.5,lr=4e-4, input_dims=[512],n_actions=12, mem_size=1_000_000, eps_min=0.01, batch_size=64,checkpoint_name="team2",eps_dec=2e-5,replace=100)
