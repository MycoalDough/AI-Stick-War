...
if(__name__ == "__main__"):
    ...
    agent1 = Agent(gamma=0.99,epsilon=.5,lr=4e-4, input_dims=[724],n_actions=22, mem_size=1_000_000, eps_min=0.01, batch_size=32, checkpoint_name="team1",eps_dec=2e-6,replace=100)
    agent2 = Agent(gamma=0.99,epsilon=.5,lr=4e-4, input_dims=[720],n_actions=15, mem_size=1_000_000, eps_min=0.01, batch_size=32,checkpoint_name="team2",eps_dec=2e-6,replace=100)
